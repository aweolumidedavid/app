...
export class Config {
    debugLogging = 'debug';
    'server.port' = '4500';
    'jhipster.clientApp.name' = 'tenantapp';
    ...
    'jhipster.mail.from' = 'tenantapp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'tenantapp API';
    'jhipster.swagger.description' = 'tenantapp API documentation';
    ...
    'eureka.instance.appname' = 'tenantapp';
    'eureka.instance.instanceId' = 'tenantapp:${random.value}';
